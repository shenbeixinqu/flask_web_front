      ...
      >
        ...
        >
          <template slot-scope="scope">
            <el-button
              size="mini"
              @click="editLoophole(scope.row)"
            >编辑</el-button>
            <el-button
              size="mini"
              @click="previewLoophole(scope.row)"
            >预览</el-button>
            <el-button
              size="mini"
              @click="delLoophole(scope.row)"
            >删除</el-button>
          </template>
        </el-table-column>
      </el-table>
...
import { getLoopholeList, addLoophole, deleteLoophole } from '@/api/safeCenter'
...
export default {
  ...
  methods: {
    ...
    // 添加
    addLoophole() {
      this.dialogTitle = '漏洞发布添加'
      this.addDialogVisible = true
    },
    editLoophole(row) {
      this.dialogTitle = '漏洞发布修改'
      this.addDialogVisible = true
    ...
    // 确认删除
    saveDeleteDialog() {
      deleteLoophole(this.deleteForm).then(res => {
